...
CREATE TABLE orders (
 oid int NOT NULL GENERATED ALWAYS AS IDENTITY
        (START WITH 1, INCREMENT BY 1),
 pid varchar(15) DEFAULT NULL,
 sid varchar(15) DEFAULT NULL,
 uid varchar(20) DEFAULT NULL,
 orderdatetime Timestamp DEFAULT NULL orderdatetime BY (CASE WHEN [Submission Date] IS NULL THEN 1 ELSE 0 END) DESC, 
